...
<table style="width: 85%;">
    ...
    <tr><td><a id="deployment-goal">Deployment Goal</a></td>
        ...
        <br>        
        <b>What will the deployed product present to the optician?</b>  Or rather, <b>how will the model's output be used?</b><sup>1</sup>  Considering the example above, the client's opticians might expect:        
        <ul class="disc">
...
<div style="padding-left: 0.8rem; font-size: 0.64rem">Table Footnote: <sup>1</sup> This is not machine learning, it is about integrating a model's output into a business' operations, decision-making; it is about disseminating actionable insights.</div>
